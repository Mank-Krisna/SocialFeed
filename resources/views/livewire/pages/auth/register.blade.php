...
<div class="space-y-6">
    <div class="text-center space-y-1">
        <h2 class="text-2xl font-bold text-[var(--text-primary)]">Buat Akun Baru</h2>
        <p class="text-xs text-[var(--text-secondary)]">Daftar gratis untuk mulai berbagi status dan terhubung.</p>
    </div>
    ...
    <form wire:submit="register" class="space-y-4">
        ...
        <!-- Email Address -->
        <div>
            <label for="email" class="block text-xs font-bold text-[var(--text-primary)] mb-1">Alamat Email</label>
            <input 
                wire:model="email" 
                id="email" 
                type="email" 
        ...
        <!-- Password -->
        <div>
            <label for="password" class="block text-xs font-bold text-[var(--text-primary)] mb-1">Kata Sandi</label>
            <input 
                wire:model="password" 
                id="password" 
                type="password" 
        ...
        <!-- Confirm Password -->
        <div>
            <label for="password_confirmation" class="block text-xs font-bold text-[var(--text-primary)] mb-1">Konfirmasi Kata Sandi</label>
            <input 
    ...
    <div class="text-center pt-4 border-t border-[var(--surface-hover)]">
        <p class="text-xs text-[var(--text-secondary)]">
            Sudah punya akun? 
            <a href="{{ route('login') }}" wire:navigate class="font-bold text-[var(--accent)] hover:underline">
                Masuk di Sini
            </a>
        </p>
    </div>
