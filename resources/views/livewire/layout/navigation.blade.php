...
<nav x-data="{ open: false }" class="bg-[var(--nav-bg)] border-b border-[var(--card-border)] sticky top-0 z-40">
    <div class="max-w-[1280px] mx-auto px-4 sm:px-4 lg:px-8">
        <div class="flex justify-between items-center h-16 gap-4">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <div class="border-t border-[var(--card-border)] dark:border-[var(--card-border)] mt-1 pt-1">
            ...
            <div class="-me-1 flex items-center gap-1 sm:hidden">
                <a href="{{ route('profile.edit') }}" wire:navigate class="p-2 rounded-lg text-[var(--text-secondary)] dark:text-[var(--text-secondary)] hover:text-[var(--text-primary)] dark:hover:text-[var(--card-border)] hover:bg-[var(--surface-hover)] dark:hover:bg-[var(--surface-hover)] transition" title="Pengaturan">
                    <span class="material-symbols-outlined text-xl">settings</span>
                </a>
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-lg text-[var(--text-secondary)] dark:text-[var(--text-secondary)] hover:text-[var(--text-primary)] dark:hover:text-[var(--card-border)] hover:bg-[var(--surface-hover)] dark:hover:bg-[var(--surface-hover)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2 transition">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden border-t border-[var(--card-border)] dark:border-[var(--card-border)] bg-white dark:bg-[var(--drawer-bg)] shadow-lg">
        ...
        <div class="pt-3 pb-4 border-t border-[var(--card-border)] dark:border-[var(--card-border)] px-4 space-y-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3 min-w-0">
                    ...
                    <div class="min-w-0">
                    <div class="font-bold text-sm text-[var(--text-primary)] dark:text-[var(--card-border)] truncate">{{ auth()->user()->name }}</div>
                    <div class="font-medium text-xs text-[var(--text-secondary)] dark:text-[var(--text-secondary)] truncate">{{ auth()->user()->email }}</div>
                    </div>
                </div>
...
<nav class="sm:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 dark:bg-[var(--mobile-bar)] backdrop-blur-md border-t border-[var(--card-border)] dark:border-[var(--card-border)] px-1 py-1 shadow-lg flex items-center justify-around">
    <a href="{{ route('feed') }}" wire:navigate class="flex flex-col items-center gap-0.5 py-1 px-2.5 rounded-xl transition {{ request()->routeIs('feed') ? 'text-[var(--accent)]' : 'text-[var(--text-secondary)] dark:text-[var(--text-secondary)] hover:text-[var(--text-primary)] dark:hover:text-[var(--card-border)]' }}">
    ...
    <a href="{{ route('friends') }}" wire:navigate class="flex flex-col items-center gap-0.5 py-1 px-2.5 rounded-xl transition {{ request()->routeIs('friends') ? 'text-[var(--accent)]' : 'text-[var(--text-secondary)] dark:text-[var(--text-secondary)] hover:text-[var(--text-primary)] dark:hover:text-[var(--card-border)]' }}">
    ...
    <a href="{{ route('groups') }}" wire:navigate class="flex flex-col items-center gap-0.5 py-1 px-2.5 rounded-xl transition {{ request()->routeIs('groups*') ? 'text-[var(--accent)]' : 'text-[var(--text-secondary)] dark:text-[var(--text-secondary)] hover:text-[var(--text-primary)] dark:hover:text-[var(--card-border)]' }}">
    ...
    <a href="{{ route('messages') }}" wire:navigate class="flex flex-col items-center gap-0.5 py-1 px-2.5 rounded-xl transition relative {{ request()->routeIs('messages*') ? 'text-[var(--accent)]' : 'text-[var(--text-secondary)] dark:text-[var(--text-secondary)] hover:text-[var(--text-primary)] dark:hover:text-[var(--card-border)]' }}">
    ...
    <a href="{{ route('notifications') }}" wire:navigate class="flex flex-col items-center gap-0.5 py-1 px-2.5 rounded-xl transition relative {{ request()->routeIs('notifications*') ? 'text-[var(--accent)]' : 'text-[var(--text-secondary)] dark:text-[var(--text-secondary)] hover:text-[var(--text-primary)] dark:hover:text-[var(--card-border)]' }}">
    ...
    <a href="{{ route('profile.show', auth()->user()->username ?? auth()->id()) }}" wire:navigate class="flex flex-col items-center gap-0.5 py-1 px-2.5 rounded-xl transition {{ request()->routeIs('profile.show') ? 'text-[var(--accent)]' : 'text-[var(--text-secondary)] dark:text-[var(--text-secondary)] hover:text-[var(--text-primary)] dark:hover:text-[var(--card-border)]' }}">
        <img src="{{ auth()->user()->avatar_url }}" alt="{{ auth()->user()->name }}" width="24" height="24" class="w-6 h-6 rounded-full object-cover border {{ request()->routeIs('profile.show') ? 'border-[var(--accent)] ring-2 ring-[var(--accent)]/20' : 'border-[var(--card-border)] dark:border-[var(--card-border)]' }}" />
