            ...
            <div class="max-w-[1100px] w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <section class="flex flex-col text-center lg:text-left space-y-4">
                    <div class="flex items-center justify-center lg:justify-start gap-3">
                        <div class="w-14 h-14 rounded-2xl bg-[#0058bc] text-white flex items-center justify-center font-black text-3xl shadow-md">
                            S
                        </div>
                        <h1 class="text-4xl lg:text-5xl font-extrabold text-[#0058bc] tracking-tight">
                            SocialFeed
                        </h1>
                    </div>
                    ...
                    <div class="hidden lg:grid grid-cols-2 gap-4 pt-6">
                        <div class="card-elevation p-4 flex items-center gap-3">
                            <span class="material-symbols-outlined text-2xl text-[#0058bc]">dynamic_feed</span>
                            <div>
                        ...
                        <div class="card-elevation p-4 flex items-center gap-3">
                            <span class="material-symbols-outlined text-2xl text-[#0058bc]">chat_bubble</span>
                            <div>
                ...
                <section class="flex justify-center lg:justify-end">
                    <div class="w-full max-w-[420px] p-6 sm:p-8 card-elevation">
                        {{ $slot }}
                    </div>
                </section>
